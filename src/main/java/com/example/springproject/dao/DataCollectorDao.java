...
public class DataCollectorDao {
  ...
  public static void initUrlMap() {
    urlMap.put("repo", "https://api.github.com/repos/alibaba/fastjson");
    urlMap.put("contributors", "https://api.github.com/repos/alibaba/fastjson/contributors");
    urlMap.put("issues", "https://api.github.com/repos/alibaba/fastjson/issues");
    urlMap.put("releases", "https://api.github.com/repos/alibaba/fastjson/releases");
    urlMap.put("commits", "https://api.github.com/repos/alibaba/fastjson/commits");
    urlMap.put("comments", "https://api.github.com/repos/alibaba/fastjson/issues/comments");
  }

  public void collectContributors() {

    int page = 1;
    String sql = "INSERT INTO contributors (name, commit_counts) VALUES (?, ?)";
    while (true) {
  ...
  public void collectIssues() {
    int page = 1;
    String sql = "INSERT INTO issues (issue_id, title, description, state, create_time, update_time, close_time, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    while (true) {
  ...
  public void collectReleases() {
    int page = 1;
    String sql = "INSERT INTO releases (tag_name, name, description, create_time, publish_time) VALUES (?, ?, ?, ?, ?)";
    while (true) {
  ...
  public void collectCommits() {
    int page = 1;
    String sql = "INSERT INTO commits (sha, message, time) VALUES (?, ?, ?)";
    while (true) {
  ...
  public void collectComments() {
    int page = 1;
    String sql = "INSERT INTO comments (issue_id, description) VALUES (?, ?)";
    while (true) {
  ...
  public void collectKeyWordsInIssueTitles() {
    ...
    String sql = "select title from issues";
...
//                    System.out.println(lema);
    ...
    String sql2 = "INSERT INTO word_frequency (name, frequency) VALUES (?, ?)";
  ...
  public void collectKeyWordsInIssueDescriptions() {
    ...
    String sql = "select description from issues";
    System.out.println("Analyzing texts...");
...
//                        System.out.println(lema);
    ...
    String sql2 = "INSERT INTO word_frequency (name, frequency) VALUES (?, ?)";
    String sql3 = "UPDATE word_frequency SET frequency = frequency + ? where name = ?";
    Set<Map.Entry<String, Integer>> entries = wordFrequency.entrySet();
    for (Map.Entry<String, Integer> entry : entries) {
      String word = entry.getKey();
      Integer frequency = entry.getValue();
