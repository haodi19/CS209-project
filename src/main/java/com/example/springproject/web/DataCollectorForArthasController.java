...
import com.example.springproject.dao.DataCollectorForArthasDao;
...
@RestController
@RequestMapping("/arthas/dataCollector")
public class DataCollectorForArthasController {

    @Autowired
    DataCollectorForArthasDao dataCollectorDao;
