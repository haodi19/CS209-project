...
import com.example.springproject.service.RepoForArthasService;
...
@RestController
@RequestMapping("/arthas/repo")
public class RepoForArthasController {
    @Autowired
    private RepoForArthasService repoService;
